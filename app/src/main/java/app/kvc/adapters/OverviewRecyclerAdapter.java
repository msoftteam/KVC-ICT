...
public class OverviewRecyclerAdapter extends RecyclerView.Adapter<OverviewRecyclerAdapter.OverViewHolder> {
    private List<OverviewModel> listOverviews;

    public OverviewRecyclerAdapter(List<OverviewModel> listOverviews) {
