...
public class RoomRecyclerAdapter extends RecyclerView.Adapter<RoomRecyclerAdapter.OverViewHolder> {
    private List<OverviewModel> listOverviews;

    public RoomRecyclerAdapter(List<OverviewModel> listOverviews) {
